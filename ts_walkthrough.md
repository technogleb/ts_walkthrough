...
2. [Экспоненциальное сглаживание](#exponential_smoothing)
3. [Семейство моделей ARIMA](#arima)
4. [Supervised подход к прогнозированию](#supervised_approach)
5. [DL подход к прогнозирования](#dl_approach)
...
## <a id='exponential_smoothing'>Экспоненциальное сглаживание</a>
...
<a id='ref_3'>[3]: [KPSS](https://en.wikipedia.org/wiki/KPSS_test)  
<a id='ref_4'>[4]: [Dicky-Fuller](https://en.wikipedia.org/wiki/Dickey–Fuller_test)  
<a id='ref_5'>[5]: [STL decomposition](http://www.nniiem.ru/file/news/2016/stl-statistical-model.pdf)  
